...
def generate_runconfig(
    ...
    azimuth_blocks : int
        ...
        Set ``n_parallel_bursts`` to the same value for full parallelism.
    halo_rows : int or None
        Overlap rows on each side of an azimuth block.  If None, dolphin
        auto-computes the minimum safe value from window and stride settings.
